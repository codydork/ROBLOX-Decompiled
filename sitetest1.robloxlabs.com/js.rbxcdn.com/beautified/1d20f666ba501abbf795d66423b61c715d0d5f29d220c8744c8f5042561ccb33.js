! function() {
    var n = {
            ...
            179: function(t, o, n) {
                ...
                e.$inject = ["$rootScope", "$window", "$timeout", "$parse"], n.Z.directive("infiniteScroll", e), o.default = e
            },
            7070: function(t, o, n) {
                "use strict";
                var e = n(5734),
            ...
            4623: function(t, o, n) {
                ...
                n.r(o), n(3329).Z.directive("limitedIcon", e), o.default = e
            },
            3329: function(t, o, n) {
                "use strict";
                var e = n(5734),
            ...
            9182: function(t, o, n) {
                ...
                n(6635).Z.constant("modalOptions", e), o.default = e
            },
            4103: function(t, o, n) {
                "use strict";
                n.r(o);
                ...
                e.$inject = ["$log", "$scope", "$sce", "$uibModalInstance", "modalData", "modalService"], n.Z.controller("modalController", e), o.default = e
            },
            6635: function(t, o, n) {
                "use strict";
                var e = n(792),
                    i = n(5734),
                    i = n.n(i)().module("modal", ["ui.bootstrap", "modalHtmlTemplate"]).config(["$uibModalProvider", "$injector", function(t, o) {
                        t.options.openedClass = "modal-open-noscroll", t.options.animation = !1, e.Lang && e.Lang.ControlsResources && o.get("languageResourceProvider").setLanguageKeysFromFile(e.Lang.ControlsResources)
                        ...
                        var o = t.$watch(function() {
                            ...
                            0 < t && (window.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach), document.querySelectorAll(n.layoutParams.modalSelector).forEach(function(t) {
                                ...
                                o && o.value.backdrop !== n.backdropStatus.static && (t.addEventListener(n.userInteraction.mouseDown, function(t) {
                                    t.button === n.mainButtonPressed && e.getTop().key && e.getTop().key.dismiss()
                                }), t.querySelector(n.layoutParams.modalContentSelector).addEventListener(n.userInteraction.mouseDown, function(t) {
                                    t.stopPropagation()
                                }))
            ...
            1965: function(t, o, n) {
                ...
                a.$inject = ["$uibModal", "modalOptions", "modalStringService"], n.Z.service("modalService", a), o.default = a
            },
            8519: function(t, o, n) {
                "use strict";
                n.r(o);
                ...
                e.$inject = ["languageResource"], n.Z.service("modalStringService", e), o.default = e
            },
            3039: function(t, o, n) {
                "use strict";
                n.r(o);
                ...
                e.$inject = ["$timeout"], n.Z.directive("toast", e), o.default = e
            },
            71: function(t, o, n) {
                "use strict";
                var e = n(5734),
            ...
            5118: function(t, o, n) {
                ...
                e.Z.directive("verticalMenu", a), o.default = a
            },
            5690: function(t, o, n) {
                "use strict";
                var e = n(5734),
